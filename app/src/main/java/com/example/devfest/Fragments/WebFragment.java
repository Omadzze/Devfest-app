...
public class WebFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.webRecyclerView);
        final ImageView trex = view.findViewById(R.id.trexImage_Web);
        TextView noInternet = view.findViewById(R.id.no_internet_text_Web);
        final ProgressBar progressBar = view.findViewById(R.id.progressBarWeb);
